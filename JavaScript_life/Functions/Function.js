...
//callback function--(a function is passed into another function as an argument)-used to handle asynchronous tasks.
function demo(name,fun){
    console.log(name);
    fun();
}
...
//ordering food using callback function...
function order(name,Non_Veg,takeaway){
...
function Non_Veg(task){
    console.log("Loading------");
    console.log("Your Order - Biriyani is getting ready🍽️....");
    console.log("............")
...
function Veg(){
    console.log("Loading------"); 
    console.log("Order is getting ready🍽️....");
    console.log("............")
    console.log("Order is Ready📦");
}
...
order('Pavithra',Non_Veg,takeaway);